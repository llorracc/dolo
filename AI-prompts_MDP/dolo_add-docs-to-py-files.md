// 2025-01-27: Add docs to py files; Repo Prompt: file tree, [Engineer], dolo_add-docs-to-py-files.md
// conda activate dolo-dev, cursor

Use @Docs/dolo, follow the instructions below
<file_tree>
...
├── └── history
├── └── ├── .what-is-this.md
├── └── └── documenting-dolo-project-python-files.md
├── docs
...
├── ├── └── t_periods_a.mod
├── ├── .ipynb_checkpoints
├── ├── └── rbc_model-checkpoint.ipynb
├── ├── notebooks
├── ├── ├── consumption_savings.ipynb
├── ├── ├── rmt3_ch11.ipynb
├── ├── ├── rbc_perfect_foresight.ipynb
├── ├── ├── .ipynb_checkpoints
├── ├── ├── ├── bufferstock-checkpoint.py
├── ├── ├── ├── StickyE-RA-PermNorm-checkpoint.ipynb
├── ├── ├── ├── BufferStockTheory-Problems-and-Solutions-checkpoint.py
├── ├── ├── ├── StickyE-RA-checkpoint.py
├── ├── ├── ├── rbc_model_cdc-checkpoint.py
├── ├── ├── ├── BufferStock-HARK-vs-dolo-checkpoint.ipynb
├── ├── ├── ├── rbc_model_Do-Not-Optimize-On-Labor-checkpoint.ipynb
├── ├── ├── ├── rbc_model-checkpoint.ipynb
├── ├── ├── ├── bufferstock-checkpoint.ipynb
├── ├── ├── ├── rbc_model_cdc-checkpoint.ipynb
├── ├── ├── ├── bufferstock_debug-checkpoint.ipynb
├── ├── ├── ├── capital-ramsey-friedman-checkpoint.ipynb
├── ├── ├── ├── capital-ramsey-friedman-k-not-m-checkpoint.ipynb
├── ├── ├── ├── bufferstock_debug-checkpoint.py
├── ├── ├── ├── rmt3_ch11-checkpoint.ipynb
├── ├── ├── ├── Friedman-RA-checkpoint.ipynb
├── ├── ├── ├── BufferStock-HARK-vs-dolo-checkpoint.py
├── ├── ├── ├── rbc_perfect_foresight-checkpoint.ipynb
├── ├── ├── ├── consumption_savings-checkpoint.ipynb
├── ├── ├── ├── StickyE-RA-Levels-checkpoint.py
├── ├── ├── ├── BufferStockTheory-Problems-and-Solutions-checkpoint.ipynb
├── ├── ├── ├── StickyE-RA-Levels-checkpoint.ipynb
├── ├── ├── └── sudden_stop-checkpoint.ipynb
├── ├── ├── rbc_model.ipynb
├── ├── └── sudden_stop.ipynb
├── ├── models_with_errors
├── ├── └── rbc_fuzzy.yaml
├── └── notebooks_docs-added
├── └── ├── consumption_savings.py
├── └── ├── rbc_model.py
├── └── ├── rbc_perfect_foresight.py
├── └── ├── rmt3_ch11.py
├── └── └── sudden_stop.py
├── .github
├── └── workflows
...
<file_contents>
File: docs/modeling_language.md
```md
The dolo language
=================
...
<meta prompt 1 = "dolo_add-docs-to-py-files">
...
For all the jupyter notebook (.ipynb) files in examples/notebooks, use a command like “jupyter nbconvert —to-script” to make equivalent .py files, and put these generated files in a directory examples/notebooks_docs-added

Do not proceed to the next phase until you have confirmed that the .py files are present in the notebooks_add-docs folder. 
...
PHASE 2:
After you have added the inline comments to each file, you can add docstrings for each function in the file.  The docstrings should make explicit reference to the documentation and to other relevant parts of the codebase.  If there are instances of the function being used in any file anywhere in directory tree dolo/examples/models/ or dolo/examples/models_/ or in dolo/examples/notebooks_docs-added/, make an excerpt from the example that illustrates the usage as found in that file.
